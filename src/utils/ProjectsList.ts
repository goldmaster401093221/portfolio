...
import {
    URWarShots, RichiesShots, XrsumShots, NextmartShots, Armsv1Shots, Armsv2Shots, ClimateShots, CovidTraxShots, DaysbeyondShots, FilmstackShots, PikturesShots, SrinivasShots, XreconShots, YoatubeShots, VortexaShots, Armsv3Shots
} from "../assets/Shots"

import {
    URWarMockup, RichiesMockup,XrsumMockup, ARMSv1Mockup, ARMSv2Mockup, ARMSv3Mockup, ClimateMockup, DaysbeyondMockup, SrinivasMockup, VortexaMockup, XreconMockup, YoatubeMockup
} from "../assets/Mockup"
...
const FeatureList = {
    ...
    Immersive: {
        ...
        description: "Immerse yourself in a captivating VR, AR, XR world, where you can explore, interact, and immerse yourself in the world of your dreams."
    }
}
...
export const ProjectsList: ProjectsListType = [
    {
        ...
        Theme: "#FFF",
        Status: "completed",
        Link: "https://business-fb-portfolio.vercel.app/",
    ...
    },
    {
        ...
        Tech: [TechInfo.RESTAPI, TechInfo.HTML, TechInfo.CSS, TechInfo.JavaScript, TechInfo.React ],
        features: [
            {
    ...
    },
    {
        ...
        Demo: { email: "demouser123@gmail.com", password: "DemoUser123" },
        Tech: [TechInfo.HTML, TechInfo.CSS, TechInfo.JavaScript, TechInfo.React, TechInfo.MySQL, TechInfo.Node ],
        features: [
            {
    ...
    },
    {
        ...
        Tech: [TechInfo.Next, TechInfo.TypeScript, TechInfo.MongoDB, TechInfo.JavaScript, TechInfo.RESTAPI],
        features: [
            {
    ...
    },
    {
        ...
        Tech: [TechInfo.GDrive, TechInfo.Node,TechInfo.HTML, TechInfo.CSS, TechInfo.JavaScript, TechInfo.RESTAPI],
        features: [
            FeatureList.Responsive,
            FeatureList.SEO,
        ],
    ...
    {
        Name: "CovidTrax",
        ShortDesc: "Track real-time COVID-19 statistics and stay informed with global and local case updates. Monitor infection rates, vaccination progress, and critical trends through interactive maps and data visualizations.",
        ...
        Tech: [TechInfo.Zustand, TechInfo.SocketIO, TechInfo.HTML, TechInfo.CSS, TechInfo.JavaScript, TechInfo.RESTAPI],
        features: [
            FeatureList.Responsive,
            FeatureList.SEO,
        ],
    ...
    },
    {
        ...
        Tech: [TechInfo.Astro, TechInfo.React, TechInfo.TypeScript,TechInfo.HTML, TechInfo.CSS, TechInfo.JavaScript, TechInfo.RESTAPI],
        features: [
            FeatureList.Responsive,
            FeatureList.SEO,
        ],
    ...
    {
        Name: "Xr Sports Arena",
        ShortDesc: "An immersive extended reality platform featuring multiple sports experiences including basketball, car racing, shooting, running, and skiing in virtual environments.",
        Desc: "XR Sports Arena is a cutting-edge extended reality platform that brings five exciting sports experiences into immersive virtual environments. Users can enjoy realistic basketball games, high-speed car driving simulations, competitive shooting challenges, endurance running tracks, and thrilling ski slopes - all with realistic physics and interactive elements. The platform supports various XR devices and offers both single-player and multiplayer modes for competitive gameplay.",
        Logo: VortexaLogo,
        Shot: XrsumShots,
        Mockup: XrsumMockup,
        Theme: "#0d1220",
        Status: "completed",
        Link: "https://drive.google.com/file/d/1Rw5mI5jv1_42nC7D2ran-AEaTpSFDk6K/view?usp=sharing",
        Source: "https://github.com/ChiragChrg/xr-sports-arena",
        // Demo: { email: "xrdemo@test.com", password: "XRDemod2024" },
        Tech: [],
        features: [
            {
                title: "Multi-Sport XR Platform",
                description: "Five complete sports experiences in one unified platform with seamless switching between different game modes and environments."
            },
            {
                title: "Advanced Physics Simulation",
                description: "Realistic physics for each sport including ball dynamics, vehicle handling, projectile trajectories, and terrain interactions."
            },
            {
                title: "Cross-Platform Multiplayer",
                description: "Competitive and cooperative multiplayer modes supporting players across different XR devices and platforms."
            },
            {
                title: "Adaptive Difficulty System",
                description: "AI that automatically adjusts challenge level based on player performance for optimal engagement."
            },
            {
                title: "Full Body Avatars",
                description: "Customizable player avatars with realistic movement tracking and social interaction capabilities."
            },
            {
                title: "Performance Analytics",
                description: "Detailed metrics and replay system to analyze and improve sports performance in each discipline."
            },
            FeatureList.Immersive,
            // FeatureList.ARSupport,
            // FeatureList.CrossPlatform,
        ],
        hideProject: false,
        LogoSize: 60,
        versions: []
    ...
    {
        Name: "Richies XR",
        ShortDesc: "A terrifying VR game that simulates walking a wooden plank at extreme heights, designed to trigger vertigo and test players' fear of heights.",
        Desc: "Richie's Plank Experience is a heart-pounding virtual reality game that plunges players into an intense fear-of-heights simulation. Standing on a narrow wooden plank hundreds of meters above a bustling city, players must muster the courage to walk forward—or risk plummeting into the abyss. With hyper-realistic physics, immersive sound design, and optional 'Nightmare Mode' with flying and firefighting challenges, this experience is a benchmark for VR fear simulations and a popular demo for testing VR immersion.",
        Logo: ArmsLogo,
        Shot: RichiesShots,
        Mockup: RichiesMockup,
        Theme: "#1a1a2e",
        Status: "completed",
        Link: "https://drive.google.com/file/d/18aEoESIvchRGYLq-_KwZvNKUYwrlQ-tL/view?usp=sharing",
        Source: "github.com",
        Tech: [],
        features: [
            {
                title: "Extreme Height Simulation",
                description: "A realistic plank-walking experience with lifelike depth perception, wind effects, and subtle plank wobbling to amplify fear."
            },
            {
                title: "Nightmare Mode",
                description: "Unlockable challenges including flying through the city as a superhero or extinguishing fires as a firefighter—adding variety to the terror."
            },
            {
                title: "Haptic Feedback Integration",
                description: "Enhanced immersion with controller vibrations and optional floor plank accessories for physical feedback when stepping off."
            },
            {
                title: "Party Mode",
                description: "Spectator screen lets others watch the player's reactions in real-time, making it a hit at VR arcades and social events."
            },
            {
                title: "Dynamic Sound Design",
                description: "3D spatial audio with gusts of wind, distant city noises, and creaking wood to deepen the sense of presence."
            },
            {
                title: "Accessibility Options",
                description: "Adjustable comfort settings (teleportation, reduced height) to accommodate players with severe fear of heights."
            },
            FeatureList.Immersive,
    ...
    {
        Name: "UR War",
        ShortDesc: "A cutting-edge Unreal Engine WebGL XR shooter blending battle royale mechanics with cross-platform VR/desktop combat in dystopian arenas.",
        Desc: "URWar is a next-generation multiplayer FPS built with Unreal Engine's WebGL and XR capabilities, delivering high-intensity tactical combat across VR and traditional platforms. Set in a cyberpunk dystopia, players engage in 5v5 objective-based matches or 50-player battle royale modes with full cross-play support. The game leverages Unreal's Nanite and Lumen technologies for stunning visuals while maintaining smooth performance in WebGL browsers and standalone XR headsets.",
        Logo: FilmstackLogo,
        Shot: URWarShots,
        Mockup: URWarMockup,
        Theme: "#1e0a3c",
        Status: "beta",
        Link: "https://drive.google.com/file/d/1d3rAzob_OLXeAvon2FI33yM9Yfx4B7QP/view?usp=sharing",
        Source: "commercial project", // Commercial project
        Tech: [
            
        ],
        features: [
            {
                title: "Cross-Reality Combat",
                description: "Seamless multiplayer between VR (Meta Quest, Pico), desktop (WebGL), and mobile players with balanced gameplay mechanics for each platform."
            },
            {
                title: "WebGL Optimization",
                description: "Unreal Engine's WebGL export with custom WASM optimizations for sub-10s load times and 60fps performance in browsers."
            },
            {
                title: "Dynamic Battlefields",
                description: "Procedurally destructible environments using Unreal Chaos physics, with day/night cycles affecting gameplay strategies."
            },
            {
                title: "XR Tactical Systems",
                description: "VR-specific mechanics like manual reloading, body-cover systems, and haptic feedback for immersive firefights."
            },
            {
                title: "Blockchain Inventory",
                description: "Web3 integration for tradable weapon skins and gear as NFTs (optional feature)."
            },
            {
                title: "AI Bot Support",
                description: "Fill matches with Unreal's MetaHuman AI bots when players are unavailable, with machine-learned combat behaviors."
            },
            FeatureList.Immersive
        ],
        hideProject: false,
